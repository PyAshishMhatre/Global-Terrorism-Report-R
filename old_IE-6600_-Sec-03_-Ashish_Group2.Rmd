...
mtext("Correlation Plot of Developing Countries", at=2.5, line=-0.5, cex=2)
...
mtext("Correlation Plot of Developed Countries", at=2.5, line=-0.5, cex=2)
...
order = 'original', addCoef.col = 'black', tl.col = 'black')
mtext("Correlation Plot of Countries in African Region", at=2.5, line=-0.5, cex=2)
...
order = 'original', addCoef.col = 'black', tl.col = 'black')
mtext("Correlation Plot of Countries in Arab Region", at=2.5, line=-0.5, cex=2)
...
order = 'original', addCoef.col = 'black', tl.col = 'black')
mtext("Correlation Plot of Countries in Asia Region", at=2.5, line=-0.5, cex=2)
...
mtext("Correlation Plot of Countries in European Region", at=2.5, line=-0.5, cex=2)
...
order = 'original', addCoef.col = 'black', tl.col = 'black')
mtext("Correlation Plot of Countries in MiddleEast Region", at=2.5, line=-0.5, cex=2)
...
order = 'original', addCoef.col = 'black', tl.col = 'black')
mtext("Correlation Plot of Countries in Northern/Southern American Region", at=2.5, line=-0.5, cex=1.5)
